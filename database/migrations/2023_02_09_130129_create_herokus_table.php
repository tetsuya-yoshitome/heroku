...
class CreateHerokusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('herokus', function (Blueprint $table) {
            ...
            $table->longText('image')->nullable()->comment('商品画像');
