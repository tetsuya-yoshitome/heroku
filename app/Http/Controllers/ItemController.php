...
class ItemController extends Controller
{
    ...
    */
    ...
    {
        $items = heroku::orderBy('created_at', 'asc')->get();
    ...
    public function index_u(Request $request, $id)
    {
        ...
        $items=DB::table('herokus')->where('id',$id)->get();
    ...
    public function create(Request $request)
    {
        ...
        $create = [
            ...
            DB::table('herokus')->insert ($create);
    ...
    public function update(Request $request,$id)
    {
        if ($request->has('button1')) {
            ...
            $this->validate($request, $validate_rule);
            $items=heroku::where('id',$id)->first();
            ...
            DB::table('herokus')->where('id',$id)->delete();
            return redirect('/item_list');
        } 
    }
